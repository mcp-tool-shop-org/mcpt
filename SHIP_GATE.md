...
- [x] `[cli|mcp|desktop]` Dangerous actions (kill, delete, restart) require explicit `--allow-*` flag (2026-02-27) — safe-by-default execution, tools run in stub mode unless promoted
- [x] `[cli|mcp|desktop]` File operations constrained to known directories (2026-02-27) — workspace config and platform cache only
- [ ] `[mcp]` SKIP: not an MCP server
- [ ] `[mcp]` SKIP: not an MCP server

## B. Error Handling

- [x] `[all]` Errors follow the Structured Error Shape: `code`, `message`, `hint`, `cause?`, `retryable?` (2026-02-27) — Typer + Rich error handling
...
- [x] `[cli|mcp|desktop]` Logging levels defined: silent / normal / verbose / debug — secrets redacted at all levels (2026-02-27) — Rich + --plain/NO_COLOR
- [ ] `[mcp]` SKIP: not an MCP server
...
- [ ] `[npm]` SKIP: npm wrapper only, primary is PyPI
